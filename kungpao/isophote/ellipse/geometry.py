...
class Geometry(object):
    ...
    def radius(self, angle):
        ...
        float
            polar radius (pixels)
        """
        # Song Huang: here EPS can not be 1.0
    ...
    def initialize_sector_geometry(self, phi):
        ...
        Computes:
         - the four vertices that define the elliptical sector on the pixel
           array.
        ...
        r1 = sma1 * eps_ / \
            math.sqrt((eps_ * math.cos(self._phi1)) ** 2 +
        ...
        r3 = sma2 * eps_ / \
            math.sqrt((eps_ * math.cos(self._phi2)) ** 2 +
