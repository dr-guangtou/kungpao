...
class Ellipse():
    ...
    def fit_image(self,
        ...
        :param sma0: float, default = None
            ...
            a clear geometry. If set to None (the default), one of the two
            actions will be taken: in case an internal Geometry instance was
            passed to the Ellipse constructor, the `sma` in that instance will
            be used.  If no Geometry instance was passed to the contructor, the
            default values `10.` will be used.
