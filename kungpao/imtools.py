...
def mask_high_sb_pixels(img, pix=0.168, zeropoint=27.0,
    ...
    msk_positive = (img > 0.0)
    msk_high_mu_1 = (zeropoint - 2.5 * np.log10(img[msk_positive] / (pix ** 2))) < mu_threshold_1
    msk_high_mu_2 = (zeropoint - 2.5 * np.log10(img[msk_positive] / (pix ** 2))) < mu_threshold_2
